<?php 
  ...
  if (isset($_POST['addstudent'])) {
  	...
  	$query = "INSERT INTO `student_info`(`name`, `studentID`, `class`, `city`, `pcontact`, `photo`) VALUES ('$name', '$studentID', '$class', '$address', '$pcontact','$photo');";
	...
	<form enctype="multipart/form-data" method="POST" action="">
		<div class="form-group">
	  	...
	  	<div class="form-group">
		    ...
		    <input name="studentID" type="text" value="<?= isset($studentID)? $studentID: '' ; ?>" class="form-control" pattern="[0-9]{6}" id="studentID" required="">
	  	</div>
	  	<div class="form-group">
	  	...
	  	<div class="form-group">
		    ...
		    <input name="pcontact" type="text" class="form-control" id="pcontact" pattern="[0-9]{3}[0-9]{3}[0-9]{4}" value="<?= isset($pcontact)? $pcontact: '' ; ?>" placeholder="5555555555" required="">
	  	</div>
	  	<div class="form-group">
